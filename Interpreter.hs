...
step (NewList e1 e2) = case (step e1) of
                            Just e1' -> Just (NewList e1' e2)
                            _        -> Nothing
...
-- typeof (NewList e1 e2) = case (typeof e1) of
--                            Just e1' -> case (typeof e2) of
--                                          Just e2' -> Just (TList e1')
--                                          _        -> Nothing
--                            _         -> Nothing
typeof (NewList e1 e2) = case (typeof e1, typeof e2) of
