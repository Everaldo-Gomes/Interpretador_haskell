...
happyExpList = Happy_Data_Array.listArray (0,57) ([17392,128,0,0,48,0,0,4032,32257,8,32832,543,3584,34784,0,0,49152,271,2174,0,0,0,57382,135,2432,32768,4032,1,0,536,32,16384,34784,32768,33,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","Exp","true","false","num","fst","snd","if","else","'+'","'&'","','","'('","')'","'{'","'}'","%eof"]
        bit_start = st * 19
        bit_end = (st + 1) * 19
...
action_24 (18) = happyShift action_25
